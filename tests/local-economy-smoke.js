...
(async () => {
  ...
  console.log(JSON.stringify({ marketSelect, remoteState, afterLargeBuy, afterDeposit, afterWithdraw, afterCraft, screenshot: path.join(__dirname, "local-economy-smoke.png") }));
})().catch(error => {
  console.error(error);
  process.exitCode = 1;
}).finally(async () => {
